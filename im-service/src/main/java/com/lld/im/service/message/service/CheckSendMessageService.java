...
public class CheckSendMessageService {
    ...
    @Resource
    private ImFriendShipService imFriendShipServiceService;
    ...
    public ResponseVO checkFriendShip(String fromId, String toId, Integer appId) {
        if (appConfig.isSendMessageCheckFriend()) {
            ...
            ResponseVO<ImFriendShipEntity> fromRelation = imFriendShipServiceService.getRelation(fromReq);
            ...
            fromReq.setAppId(appId);
            ResponseVO<ImFriendShipEntity> toRelation = imFriendShipServiceService.getRelation(fromReq);
            if (!toRelation.isOk()) {
                return toRelation;
            }
